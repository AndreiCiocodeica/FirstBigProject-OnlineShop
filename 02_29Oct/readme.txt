...
-pe pagina Order Online:    -la click pe iconita Hi, guest apare un promt sa te loghezi cu facebookul cum???????
                            ...
                            -TODO la click pe un 'add to cart' sa apara o casuta cu: -nume meal
                                                                            -price
                                                                            -Description
                                                                            -special requests
                                                                            -quantity cu plus minus
                                                                            -buton de add to my order
                            -la fiecare meal din lista exista un buton de add to cart:  -la click apare un mesaj box(cel de sus de la TODO)
                            -dupa ce s-a pregatit comanda, click pe "Order now":    -te duce la un div hidden:  -my order title
                                                                                                                -comanda respectiva cu preturi
                                                                                                                -daca sunt special requests
                                                                                                                -subtotal
                                                                                                                -total
                                                                                                                -in partea dreapta o hartacu locatia
                                                                                                                -(nu se accepta comenzi bla bla)
                                                                                                                -un buton "back to menu"
                            -trebuie salvata o comanda pregatita cu local storage
