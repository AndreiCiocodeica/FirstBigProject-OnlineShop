...
//!conditie ca toate inputurile sa nu fie nule
...
//-function clear inputs when save is clicked
function clearEditMealInputs() {
    ...
    editMealRecipe.value = '';
    editMealId.value = '';
    editMealCategory.value = '';
}
...
//remove meal from API
function deleteMealFromAPI(id) {
...
function mealDeleteMessage() {
    ...
    messageMealRemoved.className = 'item-added';
